...
public class XmlSchema implements Serializable{
	...
	int coalesceLoaderDBNum;
	double limitOfParquetFileSize;
	...
	public int getCoalesceLoaderDBNum() {
		return coalesceLoaderDBNum;
	}

	public void setCoalesceLoaderDBNum(int coalesceLoaderDBNum) {
		this.coalesceLoaderDBNum = coalesceLoaderDBNum;
	}

	public double getLimitOfParquetFileSize() {
		return limitOfParquetFileSize;
	}

	public void setLimitOfParquetFileSize(double limitOfParquetFileSize) {
