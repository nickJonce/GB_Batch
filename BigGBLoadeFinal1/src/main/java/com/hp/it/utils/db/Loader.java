...
public class Loader {
	...
	public XmlSchema loadData(String loadContent) {
		...
		xi.setCoalesceLoaderDBNum(Integer.valueOf(parserResult.getCoalesceLoaderDBNum()));
		xi.setLimitOfParquetFileSize(Double.valueOf(parserResult.getLimitOfParquetFileSize()));
